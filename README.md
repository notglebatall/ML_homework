# Содержимое
- ML_HW1.ipynb - рабочий ноутбук с первой частью
- app.py - код приложения streamlit
- df_train.csv - данные для отображения EDA (train-датасет из условия)
- example.csv - данные для теста предсказания цен через подгрузку файла
- model.pkl - pickle-файл с данными модели
- requierements.txt - описание требований к .venv
